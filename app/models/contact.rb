...
class Contact
  ITEMS = [{
     ...
     type:		'spot',
     name:  'ТЦ "Капитолий"',
     desc:   'Пр-т Вернадского, д. 6<br/>Скоро открытие!',
     coords: [55.69224199991318, 37.52791999999997]
  }, {
     type:		'spot',
     name:  'ТРЦ "Весна"',
     desc:   '84 км. МКАД (пересечение с Алтуфьевским ш.)<br/>Скоро открытие!',
     coords: [55.91282428548291, 37.58404856091115]
  }, {
     type:		'spot',
     name:  'ТРЦ "Золотой Вавилон"',
     ...
     desc:   'Ул. Проспект Мира, д. 52<br/>Скоро открытие!',
