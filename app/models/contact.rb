...
class Contact
  ITEMS = [{
     ...
     type:  'spot',
     name:  'ТЦ "Охотный Ряд"',
     desc:   'Манежная пл., дом 1, стр. 2,<br/> 1 этаж',
     coords: [55.75623074822272,37.61512369504008]
  }, {
     type:  'spot',
     name:  'Шереметьево D',
     desc:   'Аэропорт Шереметьево терминалы D и E<br/>(3 кафе: внутренние и международные направления)',
     coords: [55.962529, 37.406317]
  }, {
     type:  'spot',
     name:  'ТРЦ "АвиаПарк"',
     desc:   'Ул. Авиаконструктора Микояна, д. 10<br/>1 и 3 этажи<br/>8-926-753-83-23',
     coords: [55.790171, 37.530738]
  # }, {
  #    type:  'spot',
  #    name:  'ТРЦ "Капитолий" (Ленинградское ш.)',
  #    desc:   'Ул. Правобережная, дом 1 «Б» (пересечение Ленинградского шоссе и МКАД), IMAX',
  #    coords: [55.880836, 37.449321]
  }, {
     type:  'spot',
     name:  'ТРЦ "Колумбус"',
     desc:   'Варшавское шоссе, вл. 140<br/>8-968-996-92-44',
     coords: [55.61225992285666,37.60661406699561]
  }, {
     type:  'spot',
     name:  'ТРЦ "ЦДМ"',
     desc:   'Театральный проезд, д. 5',
     coords: [55.760232079065695, 37.625045076721214]
  }, {
     type: 'city',
     name: 'Санкт-Петербург',
     bounds: [[59.78010927415531, 29.821823999887727], [60.12450423651545, 30.783127710825212]],
  }, {
     type:  'spot',
     name:  'ТРК "Лето"',
     desc:   'г. Санкт-Петербург, Пулковское ш. 25, корп. 1, лит. А',
     coords: [59.81977525854884, 30.317017999999987]
  }, {
     type: 'city',
     name: 'Красногорск',
     ...
     type:  'spot',
     name:  'ТРЦ "Вегас-2"',
     desc:   'г. Красногорск, 65-66 км. МКАД, 3 этаж, фуд-корт<br/>8-966-342-68-34',
     coords: [55.822218985379706, 37.38642041796843]
  }, {
     type: 'city',
     name: 'Ростов-на-Дону',
     bounds: [[47.17685173934307,39.60257798354976],[47.282557114055535,39.879982768705986]],
  }, {
     type:  'spot',
     name:  'ТРЦ Горизонт',
     desc:   'г. Ростов-на-Дону, пр-т Михаила Нагибина 32/3',
     coords: [47.259303473841925,39.71987077116392]
  }, {
     type: 'city',
     name: 'Самара',
     ...
     type: 'city',
     name: 'Воронеж',
     bounds: [[51.589478, 38.829471], [51.858562, 39.577915]],
  }, {
     type:  'spot',
     name:  'Сити-парк «Град»',
     desc:   'г. Воронеж, 3-й км автотрассы «Воронеж – Москва»',
     coords: [51.787623, 39.205356]
  }, {
     type: 'city',
     name: 'Екатеринбург',
